...
The goal of Scribbly is to create an interactive, user-friendly blogging experience with secure authentication, profile management.
...
![Dashboard](./screenshots/user_blogs.png)
![LoginPage](./screenshots/create_blog.png)
